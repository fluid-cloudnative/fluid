...
// AlluxioRuntimeReconciler reconciles a AlluxioRuntime object
type AlluxioRuntimeReconciler struct {
	client.Client
	Log    logr.Logger
...
func (r *AlluxioRuntimeReconciler) Reconcile(req ctrl.Request) (ctrl.Result, error) {
	_ = context.Background()
	_ = r.Log.WithValues("alluxioruntime", req.NamespacedName)
...
func (r *AlluxioRuntimeReconciler) SetupWithManager(mgr ctrl.Manager) error {
