...
function deploy_fluid() {
    ...
    helm install --create-namespace --set runtime.jindo.smartdata.imagePrefix=registry.cn-hongkong.aliyuncs.com --set runtime.jindo.fuse.imagePrefix=registry.cn-hongkong.aliyuncs.com fluid charts/fluid/fluid
}
