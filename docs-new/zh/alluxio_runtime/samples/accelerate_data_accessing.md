...
$ kubectl get dataset hbase
NAME    UFS TOTAL SIZE   CACHED   CACHE CAPACITY   CACHED PERCENTAGE   PHASE   AGE
hbase   568.93MiB        0.00B    4.00GiB          0.0%                Bound   2m39s
```
...
default-hbase   100Gi      RWX            Retain           Bound    default/hbase                           18m
```

```shell
$ kubectl get pvc
NAME    STATUS   VOLUME           CAPACITY   ACCESS MODES   STORAGECLASS   AGE
hbase   Bound    default-hbase    100Gi      RWX            fluid          18m
```
...
查看应用和fuse pod：fuse的pod是随着应用pod的创建而自动创建的。
```shell
$ kubectl get pod
NAME                 READY   STATUS    RESTARTS   AGE
hbase-fuse-8znhd                     1/1     Running             0          20s
hbase-master-0                       2/2     Running             0          23m
hbase-worker-0                       2/2     Running             0          22m
hbase-worker-1                       2/2     Running             0          22m
