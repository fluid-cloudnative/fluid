...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		"github.com/fluid-cloudnative/fluid/api/v1alpha1.ProcessorJob":               schema_fluid_cloudnative_fluid_api_v1alpha1_ProcessorJob(ref),
...
func schema_fluid_cloudnative_fluid_api_v1alpha1_Processor(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					"job": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("github.com/fluid-cloudnative/fluid/api/v1alpha1.ProcessorJob"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"github.com/fluid-cloudnative/fluid/api/v1alpha1.ProcessorJob"},
	}
}

func schema_fluid_cloudnative_fluid_api_v1alpha1_ProcessorJob(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
