...
const (
	...
	// OnDeleteFuseUpdateStrategy cleans fuse pod once the fuse pod on some node is deleted
	OnDeleteFuseUpdateStrategy FuseUpdateStrategy = "OnDelete"

	// OnIdleFuseUpdateStrategy cleans fuse pod once the fuse pod on some node is in idle
