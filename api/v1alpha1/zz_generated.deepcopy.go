...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AlluxioScaleSpec) DeepCopyInto(out *AlluxioScaleSpec) {
	*out = *in
	if in.ScaleInSlots != nil {
		in, out := &in.ScaleInSlots, &out.ScaleInSlots
		*out = make([]int, len(*in))
		copy(*out, *in)
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AlluxioScaleSpec.
func (in *AlluxioScaleSpec) DeepCopy() *AlluxioScaleSpec {
	if in == nil {
		return nil
	}
	out := new(AlluxioScaleSpec)
	in.DeepCopyInto(out)
	return out
}
