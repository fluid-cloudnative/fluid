...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CacheFSMasterSpec) DeepCopyInto(out *CacheFSMasterSpec) {
	*out = *in
	if in.Env != nil {
		in, out := &in.Env, &out.Env
		*out = make([]v1.EnvVar, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CacheFSMasterSpec.
func (in *CacheFSMasterSpec) DeepCopy() *CacheFSMasterSpec {
	if in == nil {
		return nil
	}
	out := new(CacheFSMasterSpec)
	in.DeepCopyInto(out)
	return out
}
