...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ThinRuntimeStatus) DeepCopyInto(out *ThinRuntimeStatus) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ThinRuntimeStatus.
func (in *ThinRuntimeStatus) DeepCopy() *ThinRuntimeStatus {
	if in == nil {
		return nil
	}
	out := new(ThinRuntimeStatus)
	in.DeepCopyInto(out)
	return out
}
