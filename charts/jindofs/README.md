...
<a name="vdrsi"></a>
### 2.2 配置参数
完整的配置模板如下：<br />这里举例的镜像资源是cn-shanghai区的地址，版本号为3.5.2。**请使用安装配置页面展示的默认的image地址和tag版本。**
...
```
wget https://smartdata-binary.oss-cn-shanghai.aliyuncs.com/b2sdk-3.5.2.tar.gz
tar -zxvf b2sdk-3.5.2.tar.gz
```
