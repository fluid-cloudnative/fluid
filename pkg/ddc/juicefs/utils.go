...
// filterEncryptEnvOptionsWithKeys is a function that filters the provided
...
// options.
func filterEncryptEnvOptionsWithKeys(encriptOptions []EncryptEnvOption, keys []string) (result []EncryptEnvOption) {
...
// filterOptionsWithKeys is a function that filters the provided
...
func filterOptionsWithKeys(options map[string]string, keys []string) (result map[string]string) {
