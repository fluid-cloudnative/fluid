...
func (e *EFCEngine) setupMasterInternal() (err error) {
	var (
	...
	valuefileName, err := e.generateEFCValueFile(runtime)
	if err != nil {
		return
	}
...
// generate efc struct
func (e *EFCEngine) generateEFCValueFile(runtime *datav1alpha1.EFCRuntime) (valueFileName string, err error) {
