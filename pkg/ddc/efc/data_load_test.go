...
func TestEFCEngine_CheckExistenceOfPath(t *testing.T) {
	...
	mockNotExist := func(a operations.EFCFileUtils, eacSubPath string) (found bool, err error) {
		return false, errors.New("other error")
	}
	mockExist := func(a operations.EFCFileUtils, eacSubPath string) (found bool, err error) {
		return true, nil
	}
	wrappedUnhook := func() {
