...
func (j *CacheFSEngine) GetPodMetrics(podName, containerName string) (metrics string, err error) {
	fileUtils := operations.NewCacheFSFileUtils(podName, containerName, j.namespace, j.Log)
...
func (j *CacheFSEngine) parseMetric(metrics string) (podMetric fuseMetrics) {
