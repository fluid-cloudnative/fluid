...
func (j *CacheFSEngine) CheckWorkersReady() (ready bool, err error) {
	var (
...
func (j *CacheFSEngine) ShouldSetupWorkers() (should bool, err error) {
	runtime, err := j.getRuntime()
	if err != nil {
		return
	}
...
func (j *CacheFSEngine) SetupWorkers() (err error) {
	var (
		workerName string = j.getWorkerName()
		namespace  string = j.namespace
	)
...
func (j *CacheFSEngine) getWorkerSelectors() string {
