...
func (j *CacheFSEngine) transformResourcesForFuse(runtime *datav1alpha1.CacheFSRuntime, value *CacheFS) (err error) {
...
func (j *CacheFSEngine) transformResourcesForWorker(runtime *datav1alpha1.CacheFSRuntime, value *CacheFS) (err error) {
