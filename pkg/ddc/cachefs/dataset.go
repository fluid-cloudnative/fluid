...
func (j *CacheFSEngine) UpdateDatasetStatus(phase datav1alpha1.DatasetPhase) (err error) {
...
func (j *CacheFSEngine) UpdateCacheOfDataset() (err error) {
	// 1. update the runtime status
	runtime, err := j.getRuntime()
	if err != nil {
		return err
...
func (j *CacheFSEngine) BindToDataset() (err error) {
