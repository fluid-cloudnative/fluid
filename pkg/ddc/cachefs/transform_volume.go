...
func (j *CacheFSEngine) transformWorkerVolumes(runtime *datav1alpha1.CacheFSRuntime, value *CacheFS) (err error) {
...
func (j *CacheFSEngine) transformWorkerCacheVolumes(runtime *datav1alpha1.CacheFSRuntime, value *CacheFS) (err error) {
	cacheDir := ""
...
func (j *CacheFSEngine) transformFuseVolumes(runtime *datav1alpha1.CacheFSRuntime, value *CacheFS) (err error) {
...
// after genValue & genMount function
func (j *CacheFSEngine) transformFuseCacheVolumes(runtime *datav1alpha1.CacheFSRuntime, value *CacheFS) (err error) {
	caches := value.CacheDirs
