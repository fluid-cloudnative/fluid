...
func (j *CacheFSEngine) CheckMasterReady() (ready bool, err error) {
	// JuiceFS Runtime has no master role
	return true, nil
}

func (j *CacheFSEngine) ShouldSetupMaster() (should bool, err error) {
...
func (j *CacheFSEngine) SetupMaster() (err error) {
