...
func (j *CacheFSEngine) DeleteVolume() (err error) {
	if j.runtime == nil {
...
func (j *CacheFSEngine) deleteFusePersistentVolume() (err error) {
...
// deleteFusePersistentVolume
func (j *CacheFSEngine) deleteFusePersistentVolumeClaim() (err error) {
	runtimeInfo, err := j.getRuntimeInfo()
	if err != nil {
		return err
	}
