...
func (e *JindoCacheEngine) destroyMaster() (err error) {
	var found bool
...
func (e *JindoCacheEngine) releasePorts() (err error) {
...
func (e *JindoCacheEngine) cleanAll() (err error) {
...
func (e *JindoCacheEngine) cleanConfigMap() (err error) {
	var (
...
func (e *JindoCacheEngine) destroyWorkers(expectedWorkers int32) (currentWorkers int32, err error) {
...
func (e *JindoCacheEngine) sortNodesToShutdown(candidateNodes []corev1.Node, fuseGlobal bool) (nodes []corev1.Node, err error) {
	if !fuseGlobal {
