	...
	value := &Jindo{
		...
		Master: Master{
			FileStoreProperties: map[string]string{
				"jindocache.oss.bucket.bucket-a.endpoint": "oss-cn-shanghai.aliyuncs.com",
			},
		},
	}
...
func TestJindoCacheEngine_transformMasterWithMultipleOSSEncryptOptions(t *testing.T) {
	...
	if _, ok := value.Master.FileStoreProperties["jindocache.oss.bucket.bucket-a.provider.endpoint"]; ok {
		t.Fatalf("expected bucket-a provider endpoint to stay out of fileStoreProperties")
	}
	if _, ok := value.Master.FileStoreProperties["jindocache.oss.bucket.bucket-b.provider.endpoint"]; ok {
...
func TestJindoCacheEngine_transformMasterDedupesSameBucketSecretProjection(t *testing.T) {
	s := runtime.NewScheme()
	s.AddKnownTypes(datav1alpha1.GroupVersion, &datav1alpha1.JindoRuntime{}, &datav1alpha1.Dataset{})
	_ = corev1.AddToScheme(s)
...
func TestJindoCacheEngine_transformMasterRejectsConflictingSameBucketSecretProjection(t *testing.T) {
	s := runtime.NewScheme()
	s.AddKnownTypes(datav1alpha1.GroupVersion, &datav1alpha1.JindoRuntime{}, &datav1alpha1.Dataset{})
	_ = corev1.AddToScheme(s)
...
func TestJindoCacheEngine_transformMasterSupportsInlineOSSCredentialsCompatibility(t *testing.T) {
	...
	if got := value.Master.FileStoreProperties["jindocache.oss.bucket.bucket-a.accessKeyId"]; got != "inline-ak" {
		t.Fatalf("expected inline bucket-a accessKeyId to be preserved, got %q", got)
	}
	if got := value.Master.FileStoreProperties["jindocache.oss.bucket.bucket-a.accessKeySecret"]; got != "inline-sk" {
...
func TestJindoCacheEngine_transformMasterRejectsEmptyReferencedSecretKey(t *testing.T) {
	s := runtime.NewScheme()
	s.AddKnownTypes(datav1alpha1.GroupVersion, &datav1alpha1.JindoRuntime{}, &datav1alpha1.Dataset{})
	_ = corev1.AddToScheme(s)
...
func TestJindoCacheEngine_transformMasterReturnsErrorWhenReferencedSecretDataKeyMissing(t *testing.T) {
	s := runtime.NewScheme()
	s.AddKnownTypes(datav1alpha1.GroupVersion, &datav1alpha1.JindoRuntime{}, &datav1alpha1.Dataset{})
	_ = corev1.AddToScheme(s)
...
func TestJindoCacheEngine_transformMasterAcceptsBucketRootMountPoint(t *testing.T) {
	s := runtime.NewScheme()
	s.AddKnownTypes(datav1alpha1.GroupVersion, &datav1alpha1.JindoRuntime{}, &datav1alpha1.Dataset{})
	_ = corev1.AddToScheme(s)
	...
	if got := value.Master.FileStoreProperties["jindocache.oss.bucket.bucket-root.endpoint"]; got != "oss-cn-shanghai.aliyuncs.com" {
		t.Fatalf("expected bucket-root endpoint to be preserved, got %q", got)
	}
}

func TestJindoCacheEngine_transformMasterRejectsMixedOSSInlineAndSecretProjection(t *testing.T) {
	s := runtime.NewScheme()
	s.AddKnownTypes(datav1alpha1.GroupVersion, &datav1alpha1.JindoRuntime{}, &datav1alpha1.Dataset{})
	_ = corev1.AddToScheme(s)
