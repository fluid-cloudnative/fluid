...
func (e *JindoCacheEngine) CreateDataLoadJob(ctx cruntime.ReconcileRequestContext, targetDataload datav1alpha1.DataLoad) (err error) {
	...
	if !existed {
		...
		chartName := utils.GetChartsDirectory() + "/" + cdataload.DataloadChart + "/" + engineType
...
func (e *JindoCacheEngine) genDataLoadValue(image string, runtime *datav1alpha1.JindoRuntime, targetDataset *datav1alpha1.Dataset, dataload *datav1alpha1.DataLoad) *cdataload.DataLoadValue {
