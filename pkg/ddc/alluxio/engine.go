...
//Package alluxio is licensed under the Apache License, Version 2.0 (the "License");
...
type AlluxioEngine struct {
	...
	Log         logr.Logger
	client.Client
	//GracefulShutdownLimits is reached, and then the system is forced to clean up.
