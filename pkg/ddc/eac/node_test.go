...
func getTestEACEngineNode(client client.Client, name string, namespace string, withRunTime bool) *EACEngine {
	engine := &EACEngine{
		runtime:     nil,
		name:        name,
		namespace:   namespace,
...
func TestEACEngine_AssignNodesToCache(t *testing.T) {
	...
	for _, testCase := range testCases {
		engine := getTestEACEngineNode(fakeClient, testCase.name, testCase.namespace, testCase.withRunTime)
...
func TestSyncScheduleInfoToCacheNodes(t *testing.T) {
	...
	for _, testcase := range testcases {
		engine := getTestEACEngineNode(c, testcase.fields.name, testcase.fields.namespace, true)
