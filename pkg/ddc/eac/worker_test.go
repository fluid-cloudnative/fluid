...
func TestEACEngine_ShouldSetupWorkers(t *testing.T) {
	type fields struct {
		name      string
		namespace string
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if (err != nil) != tt.wantErr {
				t.Errorf("EACEngine.ShouldSetupWorkers() error = %v, wantErr %v", err, tt.wantErr)
				return
			}
			if gotShould != tt.wantShould {
				t.Errorf("EACEngine.ShouldSetupWorkers() = %v, want %v", gotShould, tt.wantShould)
			}
		})
	}
}
...
func TestEACEngine_CheckWorkersReady(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if (err != nil) != tt.wantErr {
				t.Errorf("EACEngine.CheckWorkersReady() error = %v, wantErr %v", err, tt.wantErr)
				return
			}
			if gotReady != tt.wantReady {
				t.Errorf("EACEngine.CheckWorkersReady() = %v, want %v", gotReady, tt.wantReady)
			}
		})
	}
}

func TestEACEngine_GetWorkerSelectors(t *testing.T) {
	type fields struct {
		name string
	}
	tests := []struct {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if got := e.getWorkerSelectors(); got != tt.want {
				t.Errorf("EACEngine.getWorkerSelectors() = %v, want %v", got, tt.want)
			}
		})
	}
}

func TestEACEngine_syncWorkersEndpoints(t *testing.T) {
	type fields struct {
		worker    *appsv1.StatefulSet
		pods      []*v1.Pod
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if count != tt.wantCount {
				t.Errorf("EACEngine.syncWorkersEndpoints() count = %v, wantCount %v", count, tt.wantCount)
				return
			}
		})
	}
