...
func (e *EACEngine) cleanupCache() (err error) {
	...
	for _, pod := range workerPods {
		fileUtils := operations.NewEACFileUtils(pod.Name, "eac-worker", e.namespace, e.Log)
...
func (e *EACEngine) releasePorts() (err error) {
...
func (e *EACEngine) destroyMaster() (err error) {
	var found bool
...
func (e *EACEngine) cleanAll() (err error) {
...
func (e *EACEngine) destroyWorkers(expectedWorkers int32) (currentWorkers int32, err error) {
	...
	if expectedWorkers >= 0 {
		e.Log.Info("Scale in EAC workers", "expectedWorkers", expectedWorkers)
...
func (e *EACEngine) sortNodesToShutdown(candidateNodes []corev1.Node, fuseGlobal bool) (nodes []corev1.Node, err error) {
	if !fuseGlobal {
