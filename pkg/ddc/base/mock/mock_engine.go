...
// PrepareUFSForWorkers mocks base method
func (m *MockImplement) PrepareUFSForWorkers() error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "PrepareUFSForWorkers")
	ret0, _ := ret[0].(error)
	return ret0
}

// PrepareUFSForWorkers indicates an expected call of PrepareUFSForWorkers
func (mr *MockImplementMockRecorder) PrepareUFSForWorkers() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "PrepareUFSForWorkers", reflect.TypeOf((*MockImplement)(nil).PrepareUFSForWorkers))
}
